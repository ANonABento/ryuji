...
export function buildInstructions(ctx: AppContext): string {
  ...
  return [
    ...
    "",
    "## Security",
    'role="owner": full access. role="user": can ONLY use reply, react, edit_message, fetch/search_messages, create_thread, create_poll, pin/unpin_message, imagine, memory tools, reminder tools, check_github, choomfie_status.',
