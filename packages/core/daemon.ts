 ...
 *
 * The daemon implementation lives in packages/core/daemon/*.ts. Keep this file
 * thin so structural regression tests catch accidental re-monolithing.
 */

import { DATA_DIR, TOKEN_THRESHOLD, TURN_THRESHOLD, WORKER_HEALTH_INTERVAL, WORKER_MAX_CONSECUTIVE_FAILURES, PLUGIN_DIR } from "./daemon/constants.ts";
