...
**File:** `plugins/tutor/languages/japanese/data/kana-chart.json`
...
**New data needed:**
- `plugins/tutor/languages/japanese/data/survival-vocab.json` — The 75 Stage 1 words with thematic grouping, example sentences, and cultural notes.
- `plugins/tutor/languages/japanese/data/grammar-patterns.json` — N5 grammar patterns with explanations, examples, and practice exercises.
- `plugins/tutor/languages/japanese/data/conversation-scripts.json` — Dialogue scripts for conversation practice scenarios.
...
```typescript
// In plugins/tutor/interactions.ts
